...
class Formatters {
  ...
  static String imageUrl(String? url) {
    ...
    final String baseHost = AppConfig.storageBaseHost;
    ...
    if (url.startsWith('http://') || url.startsWith('https://')) {
      try {
        ...
        // Only rewrite loopback hosts (localhost / 127.0.0.1) to the API
        // host — those are meaningless on a physical device. Arbitrary
        // private IP ranges (192.168.x, 10.x, 172.x) are left untouched.
        final isLoopback = AppConfig.isLoopbackHost(host);
