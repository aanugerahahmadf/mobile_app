...
import '../../errors/localized_error/localized_error.dart';
    ...
    if (files.isEmpty) {
      if (context.mounted) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text(l.noImagesInGoogleDrive)));
      }
      return null;
    }
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, i) {
                  ...
                  return ListTile(
                    ...
                    onTap: () =>
                        Navigator.pop(ctx, file as Map<String, dynamic>),
                  );
                },
              ),
            ),
