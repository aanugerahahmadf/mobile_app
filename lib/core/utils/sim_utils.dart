...
Future<String> extractNameFromSim(File imageFile) async {
  try {
    ...
    if (match != null) {
      ...
      if (name.length > 2 && !RegExp(r'^(tempat|jenis|gol|alamat|rt|rw|kel|kec|agama|status|pekerjaan|kewarganegaraan|berlaku|nomor)', caseSensitive: false).hasMatch(name)) {
