...
class AdminProductsPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return AdminCrudPage(
      ...
      listEndpoint: ApiEndpoints.adminProducts,
      storeEndpoint: ApiEndpoints.adminProducts,
      detailEndpoint: ApiEndpoints.adminProduct,
      updateEndpoint: ApiEndpoints.adminProduct,
      deleteEndpoint: ApiEndpoints.adminProduct,
      imageUploadEndpoint: ApiEndpoints.adminProductUpload,
      ...
      cardBuilder: (item, onEdit, onDelete) => _ProductCard(item: item, onEdit: onEdit, onDelete: onDelete),
      formFields: [
        ...
        FormFieldConfig(key: 'category_id', label: l.adminCategories, type: FormFieldType.dropdown, endpoint: ApiEndpoints.adminCategories, endpointQuery: 'type=product'),
