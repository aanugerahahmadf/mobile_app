...
class UserModel {
  ...
  factory UserModel.fromJson(Map<String, dynamic> json) {
    ...
    return UserModel(
      ...
      ktpPhotoUrl: json['ktp_photo_url'] != null
          ? Formatters.imageUrl(json['ktp_photo_url'] as String)
          : null,
      selfiePhoto: json['selfie_photo'] as String?,
      selfiePhotoUrl: json['selfie_photo_url'] != null
          ? Formatters.imageUrl(json['selfie_photo_url'] as String)
          : null,
