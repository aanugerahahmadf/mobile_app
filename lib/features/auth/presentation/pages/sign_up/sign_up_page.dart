...
import '../../../../../core/widgets/app_date_picker_field/app_date_picker_field.dart';
  ...
  Widget _buildIdentityTypePicker() {
    ...
    return Builder(
      builder: (fieldCtx) => GestureDetector(
        onTap: () =>
            _showDropdown(fieldCtx, l10n.idType, options, currentLabel, (v) {
              setState(() {
                if (v == l10n.passport) {
  ...
  Future<void> _onRegister() async {
    ...
    if (_ktpFile != null && !isVideoPath(_ktpFile!.path)) {
      if (!_namesLocked && _ocrExtractedName.isEmpty) {
        ...
        AppSnackBar.show(
          context,
          '${l.nameVerificationFailed} ${_idPhotoLabel(l)}. ${l.uploadPhoto} ${l.selfieTips}',
      ...
      if (_ocrExtractedName.isNotEmpty) {
        ...
        if (!enteredName.contains(ocrName) && !ocrName.contains(enteredName)) {
          ...
          AppSnackBar.show(
            context,
            '${l.nameNotMatch} ${_idPhotoLabel(l)}',
            type: SnackBarType.error,
          );
          return;
        }
              ...
              GestureDetector(
                onTap: () async {
                  ...
                  if (file != null) {
                    ...
                    final number = await extractIdentityNumber(
                      file,
                      _identityType,
                    );
              ...
              AppTextField(
                ...
                validator: (v) {
                  if (v == null || v.trim().isEmpty) {
                    return l.identityNumberRequired(_idLabel(l));
                  }
