      ...
      children: List.generate(maxLength, (i) {
        return AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            color: i < length ? AppColors.primaryColor : Colors.white.withValues(alpha: 0.4),
          ),
        );
      }),
    );
...
class PinEntryPad extends StatelessWidget {
  ...
  Widget _key(String digit, Color color, void Function(String) onPress) {
    return _PinKey(
      ...
      child: Text(digit, style: TextStyle(fontSize: 26, fontWeight: FontWeight.w700, color: color)),
    );
  }
