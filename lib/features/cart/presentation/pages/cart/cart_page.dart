  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    if (!isAuthenticated) {
      return Scaffold(
        ...
        body: const GuestAuthPrompt(icon: Icons.shopping_cart_outlined),
      );
    }
                  ...
                  child: RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final itemData =
                            (item['package'] ?? item['product'])
                                as Map<String, dynamic>? ??
                            {};
                        final qty = item['quantity'] as int? ?? 1;
                        final stock = Formatters.parsePrice(itemData['stock']);
                        final price = Formatters.parsePrice(
                          itemData['final_price'] ?? itemData['price'],
                        );
                        final imageUrl =
                        ...
                        final isSelected =
                            cartState.selectedIds[cartId] == true;
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      if (isOutOfStock)
                                        ...
                                        Text(
                                          l.remainingStock(stock.toString()),
                                          style: AppTextStyles.labelSmall
                                              .copyWith(
                                ...
                                Column(
                                  children: [
                                    ...
                                    IconButton(
                                      ...
                                      onPressed: () async {
                                        final v = await showAppActionSheet<
                                            String>(
                                          context,
                                          actions: [
                                            AppSheetAction(
                                              value: 'save',
                                              label: l.saveForLater,
                      ...
                      children: [
                        if (cartState.selectedItems.isNotEmpty) ...[
                          Row(
                            ...
                            children: [
                              Text(
                                l.itemsSelected(
                                  cartState.selectedItems.length.toString(),
                                ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              Formatters.currency(cartState.subtotal),
                              style: AppTextStyles.titleMedium,
                            ),
                          ],
                        ),
