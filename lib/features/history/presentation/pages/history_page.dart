...
class _HistoryPageState extends ConsumerState<HistoryPage> {
  ...
  String _statusLabel(String? status, AppLocalizations l) {
    switch (status) {
      ...
      case 'success': case 'completed': case 'approved': case 'paid': case 'confirmed': return l.completed;
      case 'failed': case 'rejected': case 'expired': return l.failed;
  ...
  Color _statusColor(String? status) {
    switch (status) {
      ...
      case 'success': case 'completed': case 'approved': case 'paid': case 'confirmed': return AppColors.successColor;
      case 'failed': case 'rejected': case 'expired': return AppColors.errorColor;
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 20),
              _detailRow(l.transactionId, '#${item.referenceNumber ?? item.id}'),
              ...
              _detailRow(l.total, '- ${Formatters.currency(item.amount.toInt())}', valueStyle: AppTextStyles.titleMedium.copyWith(color: AppColors.errorColor, fontWeight: FontWeight.w900)),
              const Divider(height: 24),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text(l.history), backgroundColor: Colors.transparent, elevation: 0),
      body: Column(
        children: [
          Padding(
                    ...
                    itemBuilder: (_, i) {
                      ...
                      return Center(
                        child: FilterChip(
                          ...
                          selected: isSelected,
                          onSelected: (_) => setState(() => _activeType = types[i]),
                        ...
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const SizedBox(height: 16),
                              TextButton(onPressed: () => notifier.fetchHistory(), child: Text(l.tryAgain)),
                            ],
                          ),
                        ),
                      )
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(height: 16),
                                  Text(l.noData, style: AppTextStyles.bodyMedium, textAlign: TextAlign.center),
                                  const SizedBox(height: 8),
                                  Text(l.noOrdersDesc, style: AppTextStyles.bodySmall, textAlign: TextAlign.center),
                                ],
                              ),
                            ),
                          )
                                            ...
                                            children: [
                                              Container(
                                                ...
                                                child: Row(
                                                  mainAxisSize: MainAxisSize.min,
                                                  children: [
                                                    Icon(_typeIcon(item.type), size: 14, color: AppColors.primaryColor),
                                                    const SizedBox(width: 4),
                                                    Text(
                                                      _typeLabel(item.type, l),
                                                      style: AppTextStyles.labelSmall.copyWith(color: AppColors.primaryColor, fontWeight: FontWeight.w600),
                                                    ),
                                                  ],
                                                ),
                                              ),
