...
import '../../../../catalog/data/models/category_model/category_model.dart';
...
class HomeData {
  ...
  factory HomeData.fromJson(Map<String, dynamic> json) {
    ...
    return HomeData(
      ...
      featuredPackages: _parseList(
        data['featured_packages'],
        (e) => ItemModel.fromJson(e as Map<String, dynamic>),
      ),
      vouchers: _parseList(
        data['vouchers'],
        (e) => VoucherModel.fromJson(e as Map<String, dynamic>),
      ),
      flashSale: _parseList(
        data['flash_sale'],
        (e) => ItemModel.fromJson(e as Map<String, dynamic>),
      ),
      upcomingOrders: _parseList(
        data['upcoming_bookings'],
        (e) => UpcomingOrder.fromJson(e as Map<String, dynamic>),
      ),
