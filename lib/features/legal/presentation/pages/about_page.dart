          ...
          child: Column(
            ...
            children: [
              Center(
                child: Column(
                  children: [
                    ...
                    Text(about.title, style: TextStyle(fontSize: 20, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
                  ],
                ),
              ),
              if (about.content != null) ...[
                const SizedBox(height: 24),
                Text(l.aboutApp, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textPrimary)),
                const SizedBox(height: 8),
                Text(
                  about.content!,
              ...
              if (about.owner != null) ...[
                ...
                Text(about.owner!, style: TextStyle(fontSize: 14, fontWeight: FontWeight.w600, color: AppColors.textPrimary)),
              ],
            ],
          ),
        ),
