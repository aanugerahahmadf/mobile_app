...
class PaymentRepositoryImpl implements PaymentRepository {
  ...
  Future<Map<String, dynamic>> confirmPayment(
    ...
    final response = await _dio.post(
      ...
      data: {'payment_method_id': paymentMethodId, ...?cardDetails},
    );
  ...
  Future<Map<String, dynamic>> createVirtualAccount(String orderId) async {
    final response = await _dio.post(ApiEndpoints.orderVirtualAccount(orderId));
    return response.data['data'] as Map<String, dynamic>;
  }

  @override
  Future<Map<String, dynamic>> createQris(String orderId) async {
    final response = await _dio.post(ApiEndpoints.orderQris(orderId));
    return response.data['data'] as Map<String, dynamic>;
  }
