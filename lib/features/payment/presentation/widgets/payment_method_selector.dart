...
class PaymentMethodSelector extends StatelessWidget {
  ...
  static const _groupOrder = ['bank_transfer', 'e_wallet', 'qris', 'credit_card'];
  ...
  Widget _buildRow(PaymentMethodInfo method, AppLocalizations l) {
    ...
    return InkWell(
      ...
      child: Container(
        color: selected ? AppColors.primaryColor.withAlpha(12) : AppColors.surfaceColor,
        ...
        child: Row(
          children: [
            Container(
              ...
              height: 40,
              decoration: BoxDecoration(
                color: selected ? AppColors.primaryColor.withAlpha(20) : AppColors.primaryColor.withAlpha(10),
                borderRadius: BorderRadius.circular(10),
              ),
              child: Icon(_icon(method.type), size: 22, color: AppColors.primaryColor),
            ),
