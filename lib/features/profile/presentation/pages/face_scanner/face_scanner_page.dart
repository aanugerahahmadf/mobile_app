...
class _FaceScannerPageState extends State<FaceScannerPage>
  ...
  void _advanceStep() {
    ...
    final l = AppLocalizations.of(context);
    if (l != null) {
      final (instruction, _) = _actionPresentation(
        _sequence[_livenessIndex],
        l,
      );
      _speak(instruction);
    }
  ...
  Widget _buildScanner() {
    final l = AppLocalizations.of(context)!;
    final (instruction, icon) = _actionPresentation(
      _sequence[_livenessIndex],
      l,
    );
        ...
        return Stack(
          children: [
            ...
            CustomPaint(
              ...
              painter: _FaceOvalPainter(faceRect: oval, color: ovalColor),
            ),
            Positioned(
