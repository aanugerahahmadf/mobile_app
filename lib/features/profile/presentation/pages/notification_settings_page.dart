...
import '../../../../core/utils/notification_prefs.dart';
        ...
        actions: [
          if (_loaded)
            TextButton(
              ...
              child: Text(
                _allEnabled ? l.disableAllNotifications : l.enableAllNotifications,
                style: TextStyle(
                  color: _allEnabled
  ...
  Widget _buildSoundTile(AppLocalizations l) {
    return Card(
      ...
      child: SwitchListTile(
        ...
        title: Text(l.notificationSoundEnabled, style: AppTextStyles.bodyMedium),
        subtitle: Text(l.notificationSoundEnabledDesc,
    ...
    return Card(
      ...
      child: SwitchListTile(
        secondary: Container(
          ...
          child: Icon(icon, color: enabled ? iconColor : AppColors.textTertiary, size: 22),
        ),
