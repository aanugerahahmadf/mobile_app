...
class _ProfilePageState extends ConsumerState<ProfilePage> {
  ...
  void initState() {
    super.initState();
    Future.microtask(_fetchProfileIfAuthenticated);
  }
      ...
      body: state.loading
          ? ListView(
              ...
              children: [
                ...
                Center(
                  child: AppShimmer(width: 96, height: 96, borderRadius: 48),
                ),
          ...
          : RefreshIndicator(
              onRefresh: _fetchProfileIfAuthenticated,
              child: ListView(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          child: CircleAvatar(
                            ...
                            backgroundImage:
                                Formatters.avatarUrl(userData) != null
                                ? CachedNetworkImageProvider(
                                    Formatters.avatarUrl(userData)!,
                                  )
                                : null,
                    ...
                    child: Column(
                      children: [
                        ...
                        _menuTile(
                          Icons.privacy_tip,
                          l.privacyAndTerms,
                          () => context.push('/legal/privacy-term'),
                        ),
                        _menuTile(
                          Icons.help,
                          l.helpCenter,
  ...
  Widget _buildProfileCompletion(
    ...
    final hasFullName =
        firstName.isNotEmpty || midName.isNotEmpty || lastName.isNotEmpty;
    ...
    if (!identityVerified) {
      ...
      final maritalStatus = (userData?['marital_status'] as String? ?? '')
          .trim();
      ...
      final sourceOfFunds = (userData?['source_of_funds'] as String? ?? '')
          .trim();
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    style: TextButton.styleFrom(
                      foregroundColor: identityVerified
