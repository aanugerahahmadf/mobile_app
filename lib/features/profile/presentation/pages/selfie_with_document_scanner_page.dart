...
class _SelfieWithDocumentScannerPageState extends State<SelfieWithDocumentScannerPage>
  ...
  _SelfieIdGuides _guideRects(Size size) {
    ...
    final usableH = h - bottomReserve - kToolbarHeight - MediaQuery.of(context).padding.top;
    final ovalW = w * 0.38;
    final ovalH = ovalW * 1.24;
    final ovalRect = Rect.fromCenter(
      center: Offset(w * 0.50, usableH * 0.20 + kToolbarHeight + MediaQuery.of(context).padding.top),
      width: ovalW,
      height: ovalH,
    );
    final cardW = w * 0.72;
    ...
    final cardRect = Rect.fromCenter(
      center: Offset(w * 0.50, usableH * 0.62 + kToolbarHeight + MediaQuery.of(context).padding.top),
      width: cardW,
      height: cardH,
    );
