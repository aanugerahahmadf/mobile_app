              ...
              : _devices.isEmpty
                  ? Center(
                      child: Column(
                        mainAxisSize: MainAxisSize.min,
                        children: [
                          Icon(Icons.devices_other, size: 64, color: AppColors.textSecondary.withValues(alpha: 0.4)),
                          const SizedBox(height: AppSizes.sm),
                          Text(l.noTrustedDevices, style: AppTextStyles.bodyMedium.copyWith(color: AppColors.textSecondary)),
                        ],
                      ),
                    )
                  : RefreshIndicator(
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              leading: CircleAvatar(
                                ...
                                child: const Icon(Icons.devices_other, color: Colors.green, size: 20),
                              ),
                              title: Text(
                              ...
                              subtitle: Column(
                                ...
                                children: [
                                  if (device['platform'] != null)
                                    Text(device['platform'], style: AppTextStyles.bodySmall),
                                  Text(
