...
class _TwoFactorSettingsPageState extends State<TwoFactorSettingsPage> {
  ...
  Future<void> _toggle2FA(bool enabled) async {
    ...
    if (enabled && (_whatsappNumber == null || _whatsappNumber!.isEmpty)) {
      AppSnackBar.show(context, l.whatsappRequired2FA, type: SnackBarType.warning);
      return;
    }

    setState(() => _toggling = true);
    try {
      await DioClient.instance.post('/security/two-factor/toggle', data: {'enabled': enabled});
  ...
  Future<void> _generateBackupCodes() async {
    final l = AppLocalizations.of(context)!;
    try {
      final resp = await DioClient.instance.post('/security/two-factor/backup-codes');
      final data = resp.data;
      if (data is Map<String, dynamic> && data['data'] is Map) {
        final codes = List<String>.from((data['data'] as Map)['backup_codes'] ?? []);
        setState(() {
  ...
  void _showGenerateBackupCodesDialog() {
    ...
    showDialog<void>(
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          TextButton(
            onPressed: () { Navigator.of(ctx).pop(); _fetchStatus(); },
            child: Text(l.later),
          ),
          TextButton(
            onPressed: () {
        ...
        builder: (ctx, scrollCtrl) => Padding(
          ...
          child: ListView(
            ...
            children: [
              ...
              Text(l.backupCodesDesc, style: AppTextStyles.bodySmall.copyWith(color: AppColors.textSecondary)),
              const SizedBox(height: AppSizes.md),
              ..._generatedCodes.map((code) => Card(
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(code, style: AppTextStyles.bodyMedium.copyWith(fontFamily: 'monospace', letterSpacing: 2)),
                          IconButton(
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () {
                    ...
                    AppSnackBar.show(context, l.allCodesCopied, type: SnackBarType.success);
                  },
                  ...
                  children: [
                    ...
                    Card(
                      ...
                      child: SwitchListTile(
                        secondary: Icon(
                          ...
                          color: _twoFactorEnabled ? Colors.green : AppColors.textSecondary,
                        ),
                        title: Text(l.enableTwoFactor, style: AppTextStyles.bodyMedium),
                        subtitle: Text(
                          _twoFactorEnabled ? l.twoFactorEnabledDesc : l.twoFactorDisabledDesc,
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            ...
                            title: Text(l.whatsapp, style: AppTextStyles.bodyMedium),
                            subtitle: Text(
                            ...
                            trailing: _whatsappVerified
                                ? Row(
                                    ...
                                    children: [
                                      ...
                                      Text(l.active, style: AppTextStyles.bodySmall.copyWith(color: Colors.green)),
                                    ],
                                  )
                          ...
                          ListTile(
                            ...
                            title: Text(l.additionalMethods, style: AppTextStyles.bodyMedium),
                            subtitle: Text(l.additionalMethodsDesc, style: AppTextStyles.bodySmall),
                    ...
                    Card(
                      ...
                      child: Column(
                        children: [
                          ListTile(
                            leading: const Icon(Icons.vpn_key_outlined, color: AppColors.primaryColor),
                            ...
                            trailing: Icon(Icons.chevron_right, color: AppColors.textSecondary),
                            onTap: _twoFactorEnabled ? () => _showGenerateBackupCodesDialog() : null,
                            shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                          ),
                        ],
                      ),
                    ...
                    Card(
                      ...
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
                      child: ListTile(
                        leading: const Icon(Icons.devices_other, color: AppColors.primaryColor),
                        title: Text(l.trustedDevices, style: AppTextStyles.bodyMedium),
                        subtitle: Text(
