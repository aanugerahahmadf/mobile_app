...
class _ReportSubmitPageState extends State<ReportSubmitPage> {
  ...
  Future<void> _submit() async {
    ...
    if (_reason == null) {
      AppSnackBar.show(context, l.reportRequiresReason, type: SnackBarType.warning);
      return;
    }

    setState(() => _submitting = true);
    try {
      await DioClient.instance.post(ApiEndpoints.reports, data: {
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.category_outlined, color: AppColors.textTertiary, size: 18),
