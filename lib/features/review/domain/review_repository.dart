abstract class ReviewRepository {
  ...
  Future<Map<String, dynamic>> getPackageReviews(String packageId, {String sort = 'newest', int? rating, bool withPhoto = false, int page = 1});
  Future<Map<String, dynamic>> getProductReviews(String productId, {String sort = 'newest', int? rating, bool withPhoto = false, int page = 1});
  Future<List<Map<String, dynamic>>> getMyReviews();
  Future<List<Map<String, dynamic>>> getUserReviews(String userId);
  Future<Map<String, dynamic>> updateReview(int id, Map<String, dynamic> data, {List<String>? photoPaths, List<String>? removedPhotoUrls});
