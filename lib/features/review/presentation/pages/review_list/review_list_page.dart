...
class _ReviewListPageState extends ConsumerState<ReviewListPage> {
  ...
  String _ratingLabel(AppLocalizations l) {
    switch (_rating) {
      case 1:
        return l.reviewStar1;
      case 2:
        return l.reviewStar2;
      case 3:
        return l.reviewStar3;
      case 4:
        return l.reviewStar4;
      default:
        return l.reviewStar5;
    }
  }
  ...
  Future<void> _submitReview() async {
    ...
    try {
      ...
      if (mounted) {
        AppSnackBar.show(
          context,
          '${l.reviewFailed}: ${LocalizedError.of(l, e.toString())}',
