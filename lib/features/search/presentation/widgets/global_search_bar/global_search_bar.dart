...
import '../../../data/models/search_suggestion/search_suggestion.dart';
import '../../../data/search_repository_impl/search_repository_impl.dart';
import '../../../../cbir/presentation/providers/cbir_provider/cbir_provider.dart';
...
class _GlobalSearchBarState extends ConsumerState<GlobalSearchBar> {
  ...
  SearchRepositoryImpl get _repo => SearchRepositoryImpl();
  ...
  Future<void> _fetchSuggestions(String query) async {
    ...
    try {
      ...
      _suggestions = result.items
          .where((e) => e.type != SuggestionType.vendors)
          .toList();
    } catch (_) {
      _suggestions = [];
    }
  ...
  Color get _textColor =>
      widget.translucent ? Colors.white : AppColors.textPrimary;
  Color get _hintColor => widget.translucent
      ? Colors.white.withAlpha(170)
      : AppColors.textSecondary.withAlpha(170);
  Color get _iconColor => widget.translucent
      ? Colors.white.withAlpha(170)
      : AppColors.textSecondary;
  Color get _fillColor => widget.translucent
      ...
      children: [
        if (item.name != null && item.name!.isNotEmpty)
          Text(
            ...
            maxLines:
                item.type == SuggestionType.terms ||
                    item.type == SuggestionType.privacy ||
                    item.type == SuggestionType.weddingPolicy
                ? 2
                : 1,
        ...
        if (item.subtitle != null && item.subtitle!.isNotEmpty) ...[
          ...
          Text(
            ...
            style: TextStyle(
              ...
              fontWeight:
                  item.type == SuggestionType.vouchers ||
                      item.type == SuggestionType.orders
                  ? FontWeight.w600
                  : FontWeight.w400,
            ),
            maxLines: 1,
