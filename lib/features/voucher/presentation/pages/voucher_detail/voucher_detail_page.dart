...
import '../../providers/voucher_provider/voucher_provider.dart';
...
class VoucherDetailPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final title = (voucher.name != null && voucher.name!.isNotEmpty)
        ? voucher.name!
        : 'Voucher';
        ...
        child: Column(
          ...
          children: [
                ...
                child: Column(
                  children: [
                    ...
                    _infoRow(
                      Icons.shopping_bag,
                      l.minPurchase,
                      Formatters.currency(voucher.minPurchase.toInt()),
                    ),
                    const Divider(),
                    _infoRow(
                      Icons.access_time,
                    ...
                    _infoRow(
                      Icons.info_outline,
                      l.tryAgain,
                      voucher.isActive ? l.active : l.inactive,
                    ),
                  ],
                ),
              ),
            ...
            AppButton(
              ...
              onPressed: (isExpired || isClaimed)
                  ? null
                  : () => _claimVoucher(context, ref),
  ...
  Future<void> _claimVoucher(BuildContext context, WidgetRef ref) async {
    ...
    final success = await ref
        ...
        .claimVoucher(voucher.id.toString());
    if (context.mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(success ? l.voucherClaimed : l.failedUseVoucher),
