...
class _VoucherListPageState extends ConsumerState<VoucherListPage> {
  ...
  Widget _buildVoucherCard(VoucherModel voucher, AppLocalizations l) {
    ...
    final name = (voucher.name != null && voucher.name!.isNotEmpty)
        ? voucher.name!
        : (code ?? 'Voucher');
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: isExpired ? null : AppColors.primaryGradient,
        color: isExpired ? AppColors.secondaryColor : null,
        borderRadius: BorderRadius.circular(AppSizes.cardRadius),
        boxShadow: [
          BoxShadow(
            color: (isExpired ? Colors.black : AppColors.primaryColor)
                .withAlpha(20),
            blurRadius: 10,
                        ...
                        Text(
                          ...
                          style: AppTextStyles.bodySmall.copyWith(
                            color: isExpired
                                ...
                                : AppColors.surfaceColor.withAlpha(179),
                          ),
                        ),
