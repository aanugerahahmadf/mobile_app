...
import '../../../data/voucher_repository_impl/voucher_repository_impl.dart';
import '../../../data/models/voucher_model/voucher_model.dart';
import '../../../domain/voucher_repository/voucher_repository.dart';

final voucherRepositoryProvider = Provider(
  (ref) => VoucherRepositoryImpl() as VoucherRepository,
);
